                ...
                <div className='wrapper'>
                    ...
                    <div className='d-block justify-content-center'>
                        <div className='d-flex justify-content-center'>
                            <button className='greyLight' onClick={clear}>AC</button>
                            <button className='greyLight' onClick={changeSign}>+/-</button>
                            {/* tem um bug com o botão de porcentagem, pois é exibido um numero muito grande e não cabe na calculadora */}
                            <button className='greyLight' onClick={porcentagem}>TIP</button>
                        ...
                        <div className='d-flex justify-content-center'>
                            ...
                            <button className='grey' style={{ visibility: "hidden" }}>k</button> {/* Esse componente serve apenas para preencher um espaço em branco e ficar escondido, não delete ele */}
